...
- [TEST_EXECUTION_LOG.md](./qa-audit/TEST_EXECUTION_LOG.md) — every live test row (TC-001 … TC-128)
- [qa_live_results.json](./qa-audit/qa_live_results.json) — raw execution payload
