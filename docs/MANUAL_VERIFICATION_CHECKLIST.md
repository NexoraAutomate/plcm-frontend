...
Derived from [USER_MANUAL_ROLE_BASED_SCENARIOS.md](./USER_MANUAL_ROLE_BASED_SCENARIOS.md). Full live API log: [qa-audit/TEST_EXECUTION_LOG.md](./qa-audit/TEST_EXECUTION_LOG.md).  
